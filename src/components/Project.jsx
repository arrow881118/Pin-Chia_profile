...
const Cards = () => {
    return (
        <div className='w-full py-10 px-4 bg-white text-black flex justify-start-center' id='project'>
            <span class="text-3xl font-bold text-black "> Project.</span>
            <div className='py-28 max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
                
                <div className=' w-full shadow-xl justify-center bg-gray-100 flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300 '>
                ...
                <div className='w-full shadow-xl bg-gray-100 flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300'>
                    ...
                    <h2 className='text-2xl font-bold text-center py-8'>VR Art Exhibition</h2>
